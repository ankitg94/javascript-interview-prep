...
// console.log(array.includes(4))//6 is not present [false]
...
// console.log(array.splice(5,0,6,7,8))//instertion purpose
...
const realArray =array2.flat(8) //flat is used for the removing  nested array  
